...
public class Generator {
    ...
    private static final String BASE_PACKAGE = "com.aoyouao.novel";
    ...
    private static void genCode(String tables) {
        ...
        /*List<String> tableList = getTables(tables);  // 调用 getTables 方法，传入表名
        // 调试输出，确保 tableList 不是空的
        System.out.println("Tables selected for code generation: " + tableList);
*/
        // 全局配置
        FastAutoGenerator.create(String.format("jdbc:mysql://%s:%s/%s?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai", DATABASE_IP, DATABASE_PORT, DATABASE_NAME), DATABASE_USERNAME, DATABASE_PASSWORD)
                .globalConfig(builder -> {
                    ...
                    System.out.println("Output directory: " + PROJECT_PATH + JAVA_PATH);
                })
                // 包配置
